...
| 2026-02-01 | **FIX cacheComponents:** Corregidas incompatibilidades con Next.js 16. Removidos `revalidate`, `dynamic`, `dynamicParams`. Implementado nuevo modelo con `'use cache'` + `cacheLife()` + `cacheTag()`. Creado CurrentYear Client Component para Footer. | src/app/products/page.tsx, src/app/products/[category]/page.tsx, src/app/products/[category]/[productId]/page.tsx, src/app/search/page.tsx, src/components/shared/CurrentYear.tsx, src/components/shared/Footer.tsx, docs/ARCHITECTURE.md, docs/LEARNING_GOALS.md |
